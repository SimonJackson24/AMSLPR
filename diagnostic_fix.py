...
os.system("sudo cp /opt/visigate/src/web/camera_routes.py /opt/visigate/src/web/camera_routes.py.backup_diagnostic")
...
if camera_route:
    ...
    if next_route:
        ...
        os.system(f"sudo sed -i '{line_number-1}r /tmp/diagnostic_cameras.py' /opt/visigate/src/web/camera_routes.py")
