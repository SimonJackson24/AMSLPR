...
os.system("sudo sed -i '/@camera_bp.route(\\'\\?\/cameras\\'\\?)/,/def cameras/!b;/@camera_bp.route(\\'\\?\/cameras\\'\\?)/,/def cameras/!d;/@camera_bp.route(\\'\\?\/cameras\\'\\?)/r /tmp/redirect_route.txt' /opt/amslpr/src/web/camera_routes.py")
