...
"""
Focused fix for the 'stats' undefined error in the cameras page
"""
...
os.system("sudo cp /opt/visigate/src/web/camera_routes.py /opt/visigate/src/web/camera_routes.py.backup_stats_fix")
...
print("Locating cameras function in the file...")
