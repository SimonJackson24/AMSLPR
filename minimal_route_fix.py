...
os.system("sudo cp /opt/visigate/src/web/camera_routes.py /opt/visigate/src/web/camera_routes.py.backup_minimal_route")
...
if camera_route:
    ...
    os.system(f"sudo grep -n '@camera_bp.route' /opt/visigate/src/web/camera_routes.py | awk '$1 > {line_number}' | head -1 > /tmp/next_route.txt")
    ...
    if next_route:
        ...
        os.system(f"sudo sed -i '{line_number-1}r /tmp/minimal_route.py' /opt/visigate/src/web/camera_routes.py")
