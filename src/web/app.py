...
def create_app(config=None):
    ...
    # Register direct auth fix blueprint as a final fallback for auth/users
    try:
        from src.web.direct_auth_fix import register_direct_auth_fix
        app = register_direct_auth_fix(app)
