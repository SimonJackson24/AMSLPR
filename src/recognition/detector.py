...
try:
    ...
    logging.getLogger('VisiGate.recognition').warning("TensorFlow not available, deep learning OCR will be disabled")
try:
    ...
    try:
        ...
        logging.getLogger('VisiGate.recognition').warning(
