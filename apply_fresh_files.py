...
os.system("sudo cp ~/fresh_camera_routes.py /opt/amslpr/src/web/camera_routes.py")
os.system("sudo cp ~/fresh_cameras.html /opt/amslpr/src/web/templates/cameras.html")
