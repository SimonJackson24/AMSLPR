...
os.system("sudo cp ~/fresh_camera_routes.py /opt/visigate/src/web/camera_routes.py")
os.system("sudo cp ~/fresh_cameras.html /opt/visigate/src/web/templates/cameras.html")
